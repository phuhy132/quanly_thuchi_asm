...
public class Thu_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.thu_fragment,container,false);
        return v;
    }

    @Override
    public void onViewCreated( View view, @Nullable  Bundle savedInstanceState) {
        floatbtn=view.findViewById(R.id.fab_Thu_add);
        recyclerView=view.findViewById(R.id.rcv_Thu);
        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        gd_Dao= new Giaodich_Dao(getContext());
        list=gd_Dao.getAll("Thu");
        ktc_adapter= new khoantc_adapter(getContext(),list);
        recyclerView.setAdapter(ktc_adapter);
        img_edit=view.findViewById(R.id.CardView_img_edit_Thu);
    ...
    private void openDialogAdd() {
       ...
       editText_ngay=view.findViewById(R.id.edt_add_ngay);
        ...
        ArrayList<Phanloai> listPl=phanLoai_dao.getAll("Thu");
        ...
        btn_them_thu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (gd_Dao.Insert(gd)){
                    Toast.makeText(getContext(), "add thu thành công", Toast.LENGTH_SHORT).show();
                    list.addAll(gd_Dao.getAll("Thu"));
                    ktc_adapter.notifyDataSetChanged();
                    dialog.dismiss();
                }else {
                    Toast.makeText(getContext(), "add thu koo thành công", Toast.LENGTH_SHORT).show();
