...
public class khoanc_adapter extends RecyclerView.Adapter<khoanc_adapter.KHOANTC_VIEWHOLDER>{
...
public khoanc_adapter(Context context, ArrayList<Giaodich> list){
    this.context=context;
    this.list=list;
    chiDao= new Chi_Dao(context);
    ...
    @Override
    public void onBindViewHolder(khoanc_adapter.KHOANTC_VIEWHOLDER holder, int position) {
    Giaodich gd = list.get(position);
        ...
        holder.img_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (chiDao.Delete(gd.getMaGD())){
                    list.clear();
                    list.addAll(chiDao.getAllChi());
